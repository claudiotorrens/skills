...
KEYWORDS = ['hurricane', 'tropical storm', 'category 5', 'Atlantic season', 'tornado', 'wildfire', 'earthquake', 'magnitude', 'tsunami', 'volcanic eruption', '100-year flood', 'FEMA', 'disaster declaration', 'billion-dollar disaster', 'polar vortex', 'bomb cyclone', 'derecho', 'heat dome', 'fire season']
...
def run(live: bool = False) -> None:
    ...
    print(f"[polymarket-catastrophe-trader] mode={mode} max_pos=${MAX_POSITION} min_vol=${MIN_VOLUME} max_spread={MAX_SPREAD:.0%} min_days={MIN_DAYS}")
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Trades Polymarket prediction markets on hurricane seasons, earthquake probabilities, wildfire forecasts, and extreme weather records that trigger insurance and reinsurance markets.")
